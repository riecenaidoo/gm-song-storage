...
class ProviderTest {
	...
	/**
	 * The statement {@code URI.create(endpoint).toURL()} in the constructor , throws a checked {@code
	 * Exception}. This cannot be propagated using the {@code throws} declaration as {@code Provider}
	 * is an {@code Enum}, therefore its constructor cannot have a {@code throws} declaration.
	 *
