...
public interface PlaylistSongService extends CreateResource<PlaylistSong> {
   ...
   * <p>
   * This is typically done to facilitate merging {@code Songs} that have been discovered as identical,
   * or when the original {@code Provider} can no longer host the {@code Song}, but another {@code Provider} does.
   *
